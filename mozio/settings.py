...
SECRET_KEY = 'django-insecure-2^lu-5vw(c&!di=hr73x8c0(-z!vxl#uq3j0=_x7f33a^ch7rc'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Pakistan@1496',

        'HOST': '/cloudsql/celestial-gecko-271013:us-central1:virya-dev'
